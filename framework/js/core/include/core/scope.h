...
class Scope {
 public:
  ...
  inline void SaveClassInstance(std::shared_ptr<hippy::napi::InstanceDefine<hippy::ScreenBuilder>> instance) {
 ...
 private:
  ...
  std::shared_ptr<hippy::napi::InstanceDefine<hippy::ScreenBuilder>> instance_holder_;
